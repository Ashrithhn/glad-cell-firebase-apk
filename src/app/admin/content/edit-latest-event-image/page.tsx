...
const CONTENT_ID = 'homepage_image_latest_event';
...
export default async function AdminEditLatestEventImagePage() {
  ...
  return (
    <div className="container mx-auto py-12 px-4 max-w-3xl">
      ...
      <ManageSectionImageForm
        ...
        currentImage={image}
        imageTitle="Latest Event Section Image"
        imageDescription="Manage the image displayed in the 'Latest Program/Event' card on the homepage."
      />
    </div>
  );
}
