      ...
      <div className="flex flex-col h-full pt-6">
        <div className="flex-grow space-y-1 overflow-y-auto px-4">
          {navItemsToRender.map((item, index) => {
            ...
            return (
              <Button key={href || label} variant="ghost" className="w-full justify-start text-base hover-neon-glow" asChild onClick={handleLinkClick}>
                <Link href={href!}>
          ...
          {!isAdmin && isLoggedIn && (
            <Button variant="ghost" className="w-full justify-start text-base hover-neon-glow" asChild onClick={handleLinkClick}>
              <Link href="/profile">
          ...
          <Button variant="ghost" className="w-full justify-start text-base hover-neon-glow" onClick={handleFeedbackClick}>
        ...
        <div className="mt-auto pt-4 pb-4 px-2 space-y-4 border-t">
          ...
          {isLoggedIn && (
            <Button variant="outline" className="w-full justify-start hover-neon-glow hover:text-white" onClick={handleCombinedLogout}>
          ...
          {!isLoggedIn && !authError && (
            <>
              <Button variant="outline" className="w-full justify-start hover-neon-glow hover:text-white" asChild onClick={handleLinkClick}>
                <Link href="/login"><User className="mr-2 h-4 w-4" />Login</Link>
              </Button>
              <Button variant="default" className="w-full justify-start hover-neon-glow hover:text-white" asChild onClick={handleLinkClick}>
